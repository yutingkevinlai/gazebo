...
public:void CatchObjectInBoxFromMsg()
{
    ...
    tra.Calculate_beta(tipppose,targetpose,p);
    std::cout<<"exit tra.Calculate\n";
    ang_list=tra.GetAngList();
...
public:void Grip() // class Gripper
{
    grip=1;
...
public:void Realse_cheat() // class Gripper
{
    grip=0;
...
public:void Realse() // class Gripper
{
    grip=0;
}
...
public:void Update() // class Gripper
{
    if(grip==0)
    {
...
public:void  receivedGGininder(ConstMsgsRequestPtr &_msg)
{
	...
	std::cout << "\033[7;32m" << "Arm_Control receive : " << nearestmodel << "\033[m" << std::endl;
